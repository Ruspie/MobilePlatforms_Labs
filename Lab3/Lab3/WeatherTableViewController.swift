...
class WeatherTableViewController: UITableViewController, UISearchResultsUpdating {
    ...
    private var searchResultWeather = [Weather]()
        ...
        Alamofire.request("http://api.openweathermap.org/data/2.5/box/city?bbox=23.043985,51.542330,32.686218,56.140902,10&APPID=e514485a6c0cc7dff90d0e02f1a31798").responseJSON {
            ...
            if response.result.value != nil {
                ...
                for data in array {
                    ...
                    self.weathers.append(Weather(sity: sity, temperature: temperature, wind: wind, description: description, longitude: longitude, latitude: latitude))
                }
    ...
    func filterContent(searchText: String){
        searchResultWeather = weathers.filter({ (weather: Weather) -> Bool in
